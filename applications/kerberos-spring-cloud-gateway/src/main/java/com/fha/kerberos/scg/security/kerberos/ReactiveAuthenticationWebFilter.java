 ...
 * {@link #ReactiveAuthenticationWebFilter(ReactiveAuthenticationManager)} is used to perform
 * authentication.</li>
 * <li>The {@link ReactiveAuthenticationManagerResolver} specified in
 * {@link #ReactiveAuthenticationWebFilter(ReactiveAuthenticationManagerResolver)} is used to
 ...
 * @since 5.0
 * Reactive authentication filter to work with Kerberos, based on AuthenticationWebFilter.
 *
 * @see AuthenticationWebFilter
 */
public class ReactiveAuthenticationWebFilter implements WebFilter {

  private static final Log logger = LogFactory.getLog(ReactiveAuthenticationWebFilter.class);
   ...
   */
  public ReactiveAuthenticationWebFilter(ReactiveAuthenticationManager authenticationManager) {
   ...
   * @since 5.3
   */
  public ReactiveAuthenticationWebFilter(
